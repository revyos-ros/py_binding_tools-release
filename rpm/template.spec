...
Name:           ros-jazzy-py-binding-tools
Version:        2.0.1
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS py_binding_tools package

License:        BSD
URL:            http://wiki.ros.org/py_binding_tools
Source0:        %{name}-%{version}.tar.gz

Requires:       ros-jazzy-geometry-msgs
Requires:       ros-jazzy-pybind11-vendor
...
%changelog
* Thu Dec 19 2024 Robert Haschke <rhaschke@techfak.uni-bielefeld.de> - 2.0.1-1
- Autogenerated by Bloom

* Sat May 25 2024 Robert Haschke <rhaschke@techfak.uni-bielefeld.de> - 2.0.0-1
- Autogenerated by Bloom
